...
public class Help implements ActionListener {
  ...
  private static JButton backButton;
    ...
    JLabel tutorial = new JLabel("<html>Input two animals shown on main screen. Click submit. Wait for the duel to finish. You can then click rematch to replay the duel. Back to select another animal, when you are done with the game click exit to leave.</html>");
